...
class PressureSensor(sensorManager: SensorManager) : SensorEventListener, SensorCardData {
    override val sensorTitle = "Luftdruck"
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        sensorData = listOf(SensorData("Luftdruck", "${event!!.values[0]} hPa"))
    }
